...
// AMR50 drives on down that aisle and stops near the middle
...
// World placement of the Final Scene model (no rotation): its +x edge
// (3.2668) on B2's wall, its aisle on AMR50's line. Factory 2 model-local ->
// world: x = -1.5515 - lx, z = -16.1596 - lz.
export const FINAL_SCENE_POSITION = [
  -1.5515 - FACTORY3_NEAR_X - 3.2668,
  0,
  -16.1596 - 0.018 - -0.05,
];
const FINAL_SCENE_STOP_X = 0.3; // trolley then fully inside the aisle
