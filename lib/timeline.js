...
// [AMR50_EXIT_END, FINAL_PARK_END] : the Final Scene's closing beat. The
//                              AMR10 towing a trolley drives on out of the
//                              room, while AMR50 pulls forward past its
//                              parking bay, stops, and reverses its trolley
//                              round into the bay beside the room's parked
//                              AMR50 (see amr50Paths.js), coming to rest
//                              parallel to it.
//
...
const PHASE_VH = [
  ...
  ["FINAL_PARK", SECTION_VH], // 8. AMR10 leaves, AMR50 reverses into its parking bay
];
