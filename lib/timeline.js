...
// [AMR50_EXIT_END, FINAL_PARK_END] : the Final Scene's closing beat, with
//                              AMR50 at rest where it stopped, and the AMR10
//                              towing two carts at rest in its lane: the
//                              APT20 carrying a pallet pulls on past its
//                              parking bay, stops, and reverses forks first
//                              round into the bay beside the room's parked
//                              AMR50 (see finalScenePaths.js), coming to
//                              rest parallel to it.
//
...
const PHASE_VH = [
  ...
  ["FINAL_PARK", SECTION_VH], // 8. the APT20 reverses into its parking bay
];
...
export const AMR50_EXIT_END = PHASE_END.AMR50_EXIT;
export const FINAL_PARK_END = 1.0;
