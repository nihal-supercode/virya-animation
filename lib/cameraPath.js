...
import { getAmr50Position, FINAL_SCENE_POSITION } from "./amr50Paths";
import {
  getExitT,
...
// robot arm and conveyor at the bottom, pallet rack and APT at the top,
// AMR50's entry aisle running through the middle. It takes over from the
// side view as B2 dissolves into the Final Scene and AMR50 drives in, and
// settles as AMR50 stops.
const FINAL_VIEW_TARGET = new THREE.Vector3(
  FINAL_SCENE_POSITION[0],
  0.2,
  FINAL_SCENE_POSITION[2] + 0.25
);
const FINAL_VIEW_AZIMUTH = THREE.MathUtils.degToRad(50);
